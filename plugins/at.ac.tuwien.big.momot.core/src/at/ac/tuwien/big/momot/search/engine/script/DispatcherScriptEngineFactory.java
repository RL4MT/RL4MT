...
public class DispatcherScriptEngineFactory implements ScriptEngineFactory {
   ...
   public List<String> getExtensions() {
      return Collections.unmodifiableList(CollectionUtil.newList("ocl"));
   }
   ...
   public List<String> getMimeTypes() {
      return Collections.unmodifiableList(CollectionUtil.newList("text/plain"));
   }

   @Override
   public List<String> getNames() {
      return Collections.unmodifiableList(CollectionUtil.newList("Dynamic Dispatcher (registered Languages)"));
   }
