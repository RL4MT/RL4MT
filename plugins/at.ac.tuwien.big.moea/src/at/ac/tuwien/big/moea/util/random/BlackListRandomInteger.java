...
public class BlackListRandomInteger extends RandomInteger {
   ...
   public BlackListRandomInteger(final int lowerBound, final int upperBound) {
      super(lowerBound, upperBound);
   }

   public BlackListRandomInteger addToBlackList(final int number) {
   ...
   public Integer nextRandom(final boolean addToBlackList) {
