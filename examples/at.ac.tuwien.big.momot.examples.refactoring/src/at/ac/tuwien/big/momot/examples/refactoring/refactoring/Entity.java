 ...
 * </p>
 * <ul>
 * <li>{@link at.ac.tuwien.big.momot.examples.refactoring.refactoring.Entity#getOwnedAttribute <em>Owned
 * Attribute</em>}</li>
 * <li>{@link at.ac.tuwien.big.momot.examples.refactoring.refactoring.Entity#getSpecialization
 * <em>Specialization</em>}</li>
 * <li>{@link at.ac.tuwien.big.momot.examples.refactoring.refactoring.Entity#getGeneralization
...
public interface Entity extends NamedElement {
   ...
   /**
    * Sets the value of the '{@link at.ac.tuwien.big.momot.examples.refactoring.refactoring.Entity#getGeneralization
